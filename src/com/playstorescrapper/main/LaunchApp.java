...
public class LaunchApp {
	...
	private Boolean scrapPlaystore(){
		...
		while(!jsonResponse.equals("NOT FOUND")){
			try {
				...
				if(htmlReviews.length() < 5)
					break;
				ParseReviews reviewParser = new ParseReviews(); 
				ArrayList<Review> reviewList = reviewParser.parseReviews(htmlReviews);
		...
		public static void main(String[] args) {
	      ...
	      packageId = "com.enparadigm.participantconnect";//in.nextLine();
